  ...
  return (
    <>
                ...
                <div className="user-drop" ref={dropRef}>
                  ...
                  {dropOpen && (
                    <div className="user-dropdown">
                      ...
                      <Link to="/my-bookings" className="drop-item" onClick={() => setDropOpen(false)}>
        ...
        {isAuthenticated ? (
          <>
            ...
            <div className="mobile-actions">
              <Link to="/booking" className="btn btn-primary btn-block">Book Now</Link>
            </div>
          </>
        ) : (
          <div className="mobile-actions">
            <Link to="/signin" className="btn btn-outline btn-block">Sign In</Link>
      ...
      <style>{`
        ...
        /* Mobile menu — always in DOM, toggled via .open */
        .mobile-menu {
        ...
        .mobile-link.active, .mobile-link:hover { color: var(--primary); background: rgba(255,255,255,0.03); }
        .mobile-link.danger { color: var(--primary); }
        .mobile-divider { height: 1px; background: var(--border); margin: 8px 0; }
        .mobile-actions {
          display: flex; flex-direction: column; gap: 10px;
          padding: 16px 24px;
        }
        .mobile-actions .btn-block { width: 100%; }
