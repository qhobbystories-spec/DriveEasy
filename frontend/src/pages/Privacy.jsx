...
Legal authorities: When required by law, court order, or to protect the rights, property, or safety of AMK Motors & AutoCare, our customers, or others.
...
To exercise any of these rights, contact us at hello@amkmotors.com. We will respond within 30 days.`
  },
  {
...
When information is no longer needed, we securely delete or anonymize it.`
  },
  {
    ...
    content: `Our services are not directed to individuals under the age of 18. We do not knowingly collect personal information from children. If you believe we have inadvertently collected information from a minor, please contact us immediately at hello@amkmotors.com and we will delete it promptly.`
  },
];
          ...
          <div className="legal-layout">
            ...
            <article className="legal-content">
              <div className="legal-intro">
                <p>This Privacy Policy explains how AMK Motors & AutoCare Inc. ("we," "our," or "us") collects, uses, shares, and protects your personal information when you use our car rental services, website, and mobile application.</p>
              </div>
              ...
              <div className="legal-contact">
                ...
                <div style={{ display: 'flex', gap: 16, marginTop: 12, flexWrap: 'wrap' }}>
                  <a href="mailto:hello@amkmotors.com" className="btn btn-outline btn-sm"><Mail size={14} /> hello@amkmotors.com</a>
                  <a href="tel:+233547129448" className="btn btn-secondary btn-sm">+233 547 129 448</a>
                </div>
              </div>
            </article>
          </div>
