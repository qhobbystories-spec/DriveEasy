...
export default function Contact() {
  ...
  const contacts = [
    ...
    { icon: MapPin, label: 'Headquarters', value: 'Koforidua, Eastern Region', sub: 'Ghana, West Africa', href: '#' },
  ...
  const subjectOptions = form.subject && !subjects.includes(form.subject)
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="grid grid-2">
                    <div className="form-group">
                      ...
                      <input className="form-control" placeholder="+233 20 000 0000" value={form.phone} onChange={e => setForm(f => ({ ...f, phone: e.target.value }))} />
                    </div>
                    <div className="form-group">
              ...
              <div className="map-placeholder">
                <div className="map-pin-center">
                  <MapPin size={40} color="var(--primary)" />
                    <div style={{ fontWeight: 700, marginTop: 12 }}>AMK Motors & AutoCare HQ</div>
