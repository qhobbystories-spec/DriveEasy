...
export default function Booking() {
  ...
  const locations = ['Accra', 'Kumasi', 'Takoradi', 'Cape Coast', 'Tema', 'Koforidua'];
              ...
              <div className="booking-card">
                ...
                <div className="grid grid-2">
                  ...
                  <div className="form-group">
                    ...
                    <input type="tel" className="form-control" placeholder="+233 54 123 4567" value={driver.phone} onChange={e => setDriver(d => ({ ...d, phone: e.target.value }))} />
                  </div>
                  <div className="form-group">
