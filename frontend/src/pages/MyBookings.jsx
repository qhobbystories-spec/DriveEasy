...
export default function MyBookings() {
  ...
  const filtered = bookings.filter(b => {
    ...
    const ref = String(b.bookingNumber || b.id || '');
    const matchQuery = (b.carName || '').toLowerCase().includes(query.toLowerCase()) || ref.toLowerCase().includes(query.toLowerCase());
                ...
                <div key={b.id} className="booking-item">
                  ...
                  <div className="bi-main">
                    <div className="bi-top">
                      <div>
                        <div className="bi-id">#{b.bookingNumber || b.id}</div>
      ...
      {cancelId && (
        <div className="modal-overlay" onClick={() => setCancelId(null)}>
          <div className="modal" onClick={e => e.stopPropagation()}>
            ...
            <p>Are you sure you want to cancel booking <strong>{bookings.find(x => x.id === cancelId)?.bookingNumber || cancelId}</strong>? This action cannot be undone.</p>
