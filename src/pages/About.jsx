        ...
        <div className="container">
          <div className="about-mission">
            <div className="mission-text">
              ...
              <p>At DriveElite, we believe every journey should be extraordinary. We're not just renting cars — we're curating experiences that match the ambition and lifestyle of our clients.</p>
            ...
            <div className="mission-img">
              <img src="https://images.unsplash.com/photo-1583267746897-2cf415887172?w=700&q=80" alt="About DriveElite" />
      ...
      <section className="section">
        <div className="container">
          <div className="section-header">
            ...
            <h2>Meet the People Behind DriveElite</h2>
