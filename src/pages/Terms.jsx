...
• Crossing international borders without prior written authorization from DriveElite
...
The renter accepts full responsibility for any damage, theft, or loss not covered by the included insurance. DriveElite strongly recommends reviewing your personal auto insurance policy and credit card benefits, as they may provide additional coverage.
...
If you anticipate a late return, please contact our team as soon as possible to arrange an extension, subject to availability.`
  },
  {
    ...
    content: `These Terms and Conditions are governed by and construed in accordance with the laws of the State of New York, United States. Any disputes arising from these terms or your use of DriveElite services shall be subject to the exclusive jurisdiction of the courts of New York County, NY.
          ...
          <div className="legal-layout">
            ...
            <article className="legal-content">
              <div className="legal-intro">
                <p>By accessing or using DriveElite's website, mobile application, or rental services, you agree to be bound by these Terms and Conditions. These terms constitute a legally binding agreement between you ("Customer," "Renter," or "You") and DriveElite Inc. ("DriveElite," "We," or "Us").</p>
              </div>
              ...
              <div className="legal-contact">
                ...
                <p><strong>DriveElite Inc.</strong><br />150 W 51st St, New York, NY 10019<br />legal@driveelite.com<br />+1 (800) 555-0100</p>
              </div>
            </article>
          </div>
        </div>
