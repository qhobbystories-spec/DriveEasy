...
export default function Home() {
  ...
  const stats = [
    ...
    { value: '25+', label: 'City Locations' },
    { value: '4.9★', label: 'Average Rating' },
  ];

  const features = [
    { icon: Shield, title: 'Full Insurance Coverage', desc: 'Every rental includes comprehensive coverage for your total peace of mind.' },
    { icon: Clock, title: '24/7 Support', desc: 'Our team is always available to assist you, day or night, wherever you are.' },
    { icon: MapPin, title: 'Flexible Pickup', desc: 'Pick up from any of our 25+ locations or get delivery to your door.' },
    { icon: HeadphonesIcon, title: 'Concierge Service', desc: 'Premium members get a dedicated concierge for a truly seamless experience.' },
  ];
        ...
        <div className="container hero-content">
          <div className="hero-text animate-fadeInUp">
            <div className="hero-badge">
              <span>⚡</span> Premium Car Rentals
            </div>
            <h1>
              Drive the Car<br />
              <span className="hero-accent">You Deserve</span>
            </h1>
            <p>Discover our curated fleet of luxury, sports and electric vehicles. Seamless booking, flexible plans, unmatched service.</p>
        ...
        <div className="container">
          <div className="why-inner">
            <div className="why-left">
              <div className="label">Why DriveElite</div>
      ...
      <section className="section">
        <div className="container">
          <div className="section-header">
            ...
            <p>Real stories from real customers who chose DriveElite for their journeys.</p>
          </div>
